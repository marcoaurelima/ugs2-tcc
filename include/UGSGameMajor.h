...
class UGSGameMajor : public UGSFunctions
{
    ...
    private:
        ...
        std::vector<bool>       mSequenceBoolTiles; /// este vector ter� o tamanho da quantidade de notas. se acretar, true na msm posicao relativa ao tile
        ...
        sf::Music  mMusic; /// audio do intrumento principal que ser� jogado
        sf::Music  mIntro; /// audio da introdu��o do jogo//
        ...
        char mKeyboardConfig[6];       /// define quais os botoes do teclado ser�o usados no jogo
        int  mPosX;
        int  mPosY;
